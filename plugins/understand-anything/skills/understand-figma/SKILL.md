...
description: Analyze a Figma file through the Figma REST API and generate an Understand
  Anything design knowledge graph of pages, screens, components, component sets, instances,
  and design tokens. Use when the user provides a Figma file URL or key and wants
  a persistent interactive design model. Requires the upstream Figma API prerequisites
