...
description: Analyze a Karpathy-pattern LLM wiki or compatible structured knowledge
  base and generate an Understand Anything knowledge graph with articles, sources,
  entities, implicit relationships, and topic clusters. Use when the source is a wiki
  or knowledge-base directory rather than a code repository.
---
